  ...
  useEffect(() => {
    ...
    if (authCookie) {
      try {
        ...
        console.log("Dashboard redirect - User role:", userData.role) // Para depuración

        // Redirigir según el rol
        if (userData.role === "company") {
          console.log("Dashboard redirect - Redirecting to company dashboard") // Para depuración
          router.push("/dashboard-company/dashboard")
        } else if (userData.role === "agent") {
          console.log("Dashboard redirect - Redirecting to agent dashboard") // Para depuración

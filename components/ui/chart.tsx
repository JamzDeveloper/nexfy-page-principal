...
function ChartComponent({ data, options = {}, type, height = 400, width, className }: ChartProps) {
  ...
  return (
    <div style={{ height: `${height}px`, width: width ? `${width}px` : "100%" }} className={className}>
